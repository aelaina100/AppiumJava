...
public class N_realTime_eCommerce_app extends Base {
	...
	@Test
	public void eCommerceApp() throws MalformedURLException, URISyntaxException, InterruptedException
	{
		...
		driver.findElement(By.cssSelector("[text= 'Canada']")).click();
		//String countryLocator= "//*[text()='"+ country + "']"; // will NOT work as HTML code is NOT like:    <a id="Joining" href="https://courses.rahulshettyacademy.com/sign_up">Canada</a>
