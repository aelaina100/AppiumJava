...
public class AppiumEmulatorBasicsTest {
	...
	@Test(enabled=true)
	public void appiumEmulatorBasics1() throws MalformedURLException, URISyntaxException
	{
		/* Pre-conditions:
    ...
    // Below method/ test case is to start and stop Appium Server programmatically using AppiumServerBuilder (Instead of launching it manually):
		 ...
		 */
	@Test(enabled=false)
	public void  appiumEmulatorBasics2() throws MalformedURLException, URISyntaxException
	{   
